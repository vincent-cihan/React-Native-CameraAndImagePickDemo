...
import { DeviceInfo, Dimensions, InteractionManager, NativeModules, Platform, SafeAreaView, StyleSheet, Animated } from 'react-native';
...
class SafeView extends Component {
  ...
  render() {
    ...
    return <Animated.View ref={c => this.view = c} onLayout={this._onLayout} style={safeAreaStyle}>
        {this.props.children}
      </Animated.View>;
  }
