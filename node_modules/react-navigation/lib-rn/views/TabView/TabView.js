...
class TabView extends React.PureComponent {
  ...
  _renderTabBar = props => {
    ...
    return <TabBarComponent {...props} {...tabBarOptions} tabBarPosition={this.props.tabBarPosition} screenProps={this.props.screenProps} navigation={this.props.navigation} getLabel={this._getLabel} getTestIDProps={this._getTestIDProps} getOnPress={this._getOnPress} renderIcon={this._renderIcon} animationEnabled={animationEnabled} />;
  };
  ...
  render() {
    ...
    const swipeEnabled = options.swipeEnabled == null ? this.props.swipeEnabled : options.swipeEnabled;
